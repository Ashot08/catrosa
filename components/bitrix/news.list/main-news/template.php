...
<p class="title_mainnews"><?=GetMessage("TITLE_NEWS");?><a href="/pressa/"><?=GetMessage("ALL_NEWS");?></a></p>
<div class="row">
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="bx-newslist-block">
		...
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<div class="col-xs-5">
				<div class="bx-newslist-date"><?echo $arItem["DISPLAY_ACTIVE_FROM"]?></div>
			</div>
		<?endif?>
		...
		<div class="row">
			<div class="col-xs-5">
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<div class="bx-newslist-more"><a class="content-box-link" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?echo GetMessage("CT_BNL_GOTO_DETAIL")?></a></div>
			<?endif;?>
			</div>
		<?
