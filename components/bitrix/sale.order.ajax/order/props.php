		...
		foreach($arSource as $arProperties)
		{
			...
			<tr>
				...
				<td>
					...
					{
						?>
						<input <?if($arProperties["FIELD_NAME"] == "ORDER_PROP_4") {echo 'type="number"';} else { echo 'type="text"';}?> maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"  <?if($arProperties["FIELD_NAME"] == "ORDER_PROP_3") echo "class='phoneMask'";?>>
						<?
					}
